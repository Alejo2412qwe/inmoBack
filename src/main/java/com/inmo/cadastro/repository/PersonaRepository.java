...
@Repository
public interface PersonaRepository extends org.springframework.data.jpa.repository.JpaRepository<Persona, Long>, org.springframework.data.jpa.repository.JpaSpecificationExecutor<Persona> {
