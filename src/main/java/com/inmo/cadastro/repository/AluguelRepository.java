...
public interface AluguelRepository extends GenericRepository<Aluguel, Long> {
    ...
    @Query(nativeQuery = true, value = "SELECT * FROM aluguel WHERE alu_propietario = :id")
    List<Aluguel> getAluguelByPropietario(@Param("id") Long id);
    ...
    @Query(nativeQuery = true, value = "SELECT a.alu_id,a.alu_valor, a.alu_endereco, a.alu_propietario, a.alu_inquilino, a.alu_expiracao, a.alu_dia_pago, a.alu_foto_entrada, a.alu_foto_saida, a.alu_contrato " +
            "FROM aluguel a " +
